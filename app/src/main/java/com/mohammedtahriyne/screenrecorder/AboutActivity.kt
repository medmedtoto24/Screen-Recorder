    ...
    private fun setupRecycler() {
        val items = listOf(
            AboutItem(
                ...
                "https://youtube.com/@mohammedtahriyne?si=MU2W_B_TobhQqGuN",
                Icon.Drawable(R.drawable.ic_info)
            ),
            AboutItem(
                "YouTube",
                getString(R.string.about_youtube_label),
                "https://youtube.com/@mohammedtahriyne?si=MU2W_B_TobhQqGuN",
                Icon.Drawable(R.drawable.ic_github)
            ),
            AboutItem(
                "Instagram",
                getString(R.string.about_instagram_label),
                "https://www.instagram.com/mohammed_tahriyne?igsh=MWpoNDkzYWVvcGZh",
                Icon.Drawable(R.drawable.ic_github)
            ),
            AboutItem(
                "Facebook",
                getString(R.string.about_facebook_label),
                "https://www.facebook.com/MohammedTahriyne2002",
                Icon.Drawable(R.drawable.ic_github)
            ),
            AboutItem(
                getString(R.string.about_support_email_title),
                getString(R.string.about_support_email_subtitle),
                "mailto:mtahriyne20@gmail.com",
                Icon.Drawable(R.drawable.ic_info)
            )
        )
